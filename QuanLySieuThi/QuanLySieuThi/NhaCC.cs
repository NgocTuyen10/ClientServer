...
namespace QuanLySieuThi
{
    public partial class NhaCC : Form
    {
        ...
        public static String maNCC_Report =null;
        private void MHCCButton_Click(object sender, EventArgs e)
        {
            maNCC_Report = maNCCTextBox.Text.Trim();
            new In_MatHangCC().ShowDialog();
        }
