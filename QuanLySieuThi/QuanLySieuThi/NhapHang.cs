...
namespace QuanLySieuThi
{
    public partial class NhapHang : Form
    {
        ...
        private void setDefault()
        {
            ...
            {
                if (DangNhap.checkAceccpt == 2 || DangNhap.checkAceccpt == 1)
                {
        ...
        private void addButton2_Click_1(object sender, EventArgs e)
        {
            ...
            {
                string query = @"INSERT dbo.SpNhap ( manhap, mamh, soluong)
        ...
        {
            maPhieuNhap = MaNhaptextBox.Text.Trim();
            new In_PhieuNhap().ShowDialog();
        }

        private void NhaCCtextBox2_TextChanged(object sender, EventArgs e)
        {
            
        }

        private void MaNhaptextBox2_TextChanged(object sender, EventArgs e)
        {
            if (MaNhaptextBox2.TextLength == 0)
            {
