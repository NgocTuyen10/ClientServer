...
namespace QuanLySieuThi
{
    public partial class XuatHang : Form
    {
        ...
        private void maXuattextBox2_TextChanged(object sender, EventArgs e)
        {
            if (maXuattextBox2.TextLength == 0)
            {
        ...
        {
            maPhieuXuat = maXuattextBox2.Text.Trim();
            new In_PhieuXuat().ShowDialog();
        }
