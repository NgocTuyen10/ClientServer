...
namespace QuanLySieuThi
{
    public partial class NhanVien : Form
    {
        ...
        private void changeButton_Click(object sender, EventArgs e)
        {
            if (maNVTextBox.Text.Trim().Length != 0 || maNVTextBox.Text.Trim().Equals("NVxxx"))
            {
                String query=@"EXEC dbo.capnhat_NhanVien @maNV_ = '"+maNVTextBox.Text.Trim()+"',@tenNV_ = N'"+tenNVTextBox.Text.Trim()
                    +"',@sdt_ = '"+sdtTextBox.Text.Trim()+"', @ngaySinh_ = '"+ngaySinhDateTimePicker.Value.ToString("yyyy/MM/dd").Trim()
                    +"',@gioiTinh = N'"+gioiTinhComboBox.SelectedItem.ToString().Trim()+"',@luong_ = "+luongTextBox.Text.Trim()+",@maPB_ = '"
                    +phongTextBox.Text.Trim()+"',@NQL_ = '"+nqlTextBox.Text.Trim()+"'";
        ...
        private void addButton2_Click(object sender, EventArgs e)
        {
            ...
            {                
                ...
                string query2 = @"UPDATE dbo.PhongBan SET maNQL = '" + maQuanLyTextBox.Text.Trim() + "' WHERE maphong= '"
